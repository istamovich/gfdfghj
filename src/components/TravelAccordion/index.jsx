    ...
    <div>
      <div className="bg-white px-6 py-12 max-w-6xl mx-auto flex flex-col lg:flex-row gap-10">
        <div className="lg:w-1/2 text-center lg:text-left">
          ...
          <p className="text-gray-600 mb-6">{t("travelAccordion.description")}</p>
          <button
            onClick={scrollToContacts}
            className="bg-yellow-500 hover:bg-yellow-600 text-white font-medium py-3 px-6 rounded shadow-lg transition"
          >
                ...
                >
                  ...
                  <motion.div
                    ...
                    className={`w-4 h-4 flex items-center justify-center rounded-full ${
                      openItem === index ? "bg-[#e1ac0c]" : "bg-[#ddd]"
                    }`}
                  >
