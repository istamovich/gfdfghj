        ...
        <div className="bg-white py-12 border-t border-gray-200">
            <div className="container mx-auto px-4 flex flex-col md:flex-row justify-center items-start gap-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 w-full">
                    <div>
                        <h2 className="text-lg font-semibold mb-4">{t('booking.footer.links.title')}</h2>
                    ...
                    <div>
                        <h2 className="text-lg font-semibold mb-4">{t('booking.footer.contact.title')}</h2>
                        <p className="text-sm mb-4">
                            {t('booking.footer.contact.description')}
                        </p>
