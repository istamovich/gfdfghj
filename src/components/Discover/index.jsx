      ...
      <div className="min-h-screen">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center mb-12">
            <h2 className="text-[17px] block m-0 text-[#e1ac0c]">
              {t("discover.title")}
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {destinations.map((destination) => (
              <DestinationCard
                ...
                t={t}
                onScrollToContact={scrollToContacts} 
              />
            ))}
          </div>
        </div>
...
function DestinationCard({ destination, t, onScrollToContact }) {
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-lg flex flex-col">
      ...
      <div className="grid grid-cols-2 border-t border-gray-200">
        <button
          ...
          className="py-3 text-gray-700 font-medium hover:bg-yellow-500 transition duration-300"
        >
          {t("discover.moreInfo")}
        </button>
        <button
          onClick={onScrollToContact}
          className="py-3 text-gray-700 font-medium border-l border-gray-200 hover:bg-yellow-500 transition duration-300"
        >
          {t("discover.bookNow")}
        </button>
      </div>
